...
export default function NewUserModal({ onClose }: NewUserModalProps) {
  ...
  const save = () => {
    createUser({ variables: { name, emailAddress, role, password } }).then(
      onClose
    )
  }
  ...
  return (
    <Modal title="New User" onClose={onClose} buttons={buttons}>
      <form className="space-y-6 m-6">
        <div className="flex flex-col gap-6 mt-8">
          ...
          <div className="flex flex-col">
            <legend className="mb-2 font-medium leading-6 text-gray-900">
              Role
            </legend>
